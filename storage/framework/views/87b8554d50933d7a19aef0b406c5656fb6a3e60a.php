...
<?php $component->withAttributes([]); ?>
                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            <h5 class="font-weight-bold"><?php echo e(__('messages.player_name') . " : " . $user->name); ?> </h5>
                        </div>
    ...
    <br>
    <div class="col-lg-12">
        <?php echo e(Form::open(['method' => 'POST', 'route' => 'addBill', 'enctype' => 'multipart/form-data', 'data-toggle' => "validator", 'id' => 'addBillForm'])); ?>

        <div class="row">
            <!-- الحقول الأساسية -->
            <div class="form-group col-md-6">
                <?php echo e(Form::label('discountAmount', __('messages.discount_value') . ' <span class="text-danger">*</span>', ['class' => 'form-control-label'], false)); ?>

                <?php echo e(Form::text('discountAmount', null, ['placeholder' => __('messages.discount_value'), 'class' => 'form-control', 'id' => 'discountAmount'])); ?>

                <small class="help-block with-errors text-danger"></small>
            </div>
            
            <div class="form-group col-md-6">
                <?php echo e(Form::label('discountBecouse', __('messages.Discount_reason') . ' <span class="text-danger">*</span>', ['class' => 'form-control-label'], false)); ?>

                <?php echo e(Form::text('discountBecouse', null, ['placeholder' => __('messages.Discount_reason'), 'class' => 'form-control', 'id' => 'discountBecouse'])); ?>

                <small class="help-block with-errors text-danger"></small>
            </div>
            
            <div class="form-group col-md-6" >
                <?php echo e(Form::label('description', __('messages.payment_note') . ' <span class="text-danger">*</span>', ['class' => 'form-control-label'], false)); ?>

                <?php echo e(Form::text('description', null, ['placeholder' => __('messages.payment_note'), 'class' => 'form-control', 'id' => 'description'])); ?>

                <small class="help-block with-errors text-danger"></small>
            </div>

            <!-- الحقول المخفية: إدخال البيانات التي تم اختيارها -->
            <?php echo e(Form::hidden('categoryId', '', ['id' => 'category_id'])); ?>

            <?php echo e(Form::hidden('subscriptionId', '', ['id' => 'subscription_id'])); ?>

            <?php echo e(Form::hidden('coachId', '', ['id' => 'coach_id'])); ?>

            <?php echo e(Form::hidden('shifts', '', ['id' => 'shifts'])); ?>

            <?php echo e(Form::hidden('tags', '', ['id' => 'tags'])); ?>

            <?php echo e(Form::hidden('userId', $user->id)); ?>

            <?php echo e(Form::hidden('price', '' , ['id' => 'subsceriptionPrice'])); ?>

            <?php echo e(Form::hidden('numOfDays', '' , ['id' => 'numOfDays'])); ?>


            <div class="form-group col-md-4">
                <?php echo e(Form::label('amount', __('messages.Amount_Due :') , [ 'id' => 'amountDue', 'class' => 'form-control-label'], false)); ?>

                <?php echo e(Form::number('amount', null, ['placeholder' => __('messages.Enter_Amount_Due'), 'class' => 'form-control', 'step' => '0.01', 'required'])); ?>

                <small class="help-block with-errors text-danger"></small>
            </div>
            <div class="form-group col-md-6">
                <?php echo e(Form::label('startDate', __('messages.Date') . ' <span class="text-danger">*</span>', ['class' => 'form-control-label'], false)); ?>
...
$(document).ready(function () {
    ...
    $(document).on('click', '.coach-btn', function () {
        ...
        $.ajax({
            url: '<?php echo e(route("categories")); ?>', // رابط الراوت
...
<?php endif; ?><?php /**PATH C:\Users\USER\Desktop\km\resources\views/setting/privacy_policy_form.blade.php ENDPATH**/ ?>