...
<head>
                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            ...
                            <a href="<?php echo e(route('tax.create')); ?>" class="float-right mr-1 btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> <?php echo e(trans('messages.add_form_title',['form' => trans('messages.tax')  ])); ?></a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card">
        ...
        <div class="row justify-content-between">
            <div>
                <div class="col-md-12">
                  <form action="<?php echo e(route('tax.bulk-action')); ?>" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                    <?php echo csrf_field(); ?>
                ...
                data--submit="<?php echo e(route('tax.bulk-action')); ?>"
                data-datatable="reload" data-confirmation='true'
                data-title="<?php echo e(__('tax',['form'=>  __('tax') ])); ?>"
                title="<?php echo e(__('tax',['form'=>  __('tax') ])); ?>"
    ...
    <script>
        ...
        window.renderedDataTable = $('#datatable').DataTable({
                ...
                ajax: {
                  "type"   : "GET",
                  "url"    : '<?php echo e(route("tax.index_data")); ?>',
                  "data"   : function( d ) {
                    d.search = {
                      value: $('.dt-search').val()
                    };
                ...
                columns: [
                    ...
                    },
                    {
                        data: 'title',
                        name: 'title',
                        title: "<?php echo e(__('messages.title')); ?>"
                    },
                    {
                        data: 'value',
                        name: 'value',
                        title: "<?php echo e(__('messages.value')); ?>"
                    },
                    {
                        data: 'status',
                        name: 'status',
...
<?php endif; ?><?php /**PATH C:\Users\USER\Desktop\km\resources\views/taxes/index.blade.php ENDPATH**/ ?>