...
<head>
                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            <h5 class="font-weight-bold"><?php echo e(__('messages.Discounts')); ?></h5>
                            <?php if($auth_user->can('blog add')): ?>
                            <a href="<?php echo e(route('blog.create')); ?>" class="float-right mr-1 btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> <?php echo e(trans('messages.add_form_title',['form' => trans('messages.Discounts')  ])); ?></a>
                            <?php endif; ?>
                        </div>
    ...
    <div class="card">
        ...
        <div class="row justify-content-between">
            <div>
                <div class="col-md-12">
                  <form action="<?php echo e(route('blog.bulk-action')); ?>" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                    <?php echo csrf_field(); ?>
                ...
                data--submit="<?php echo e(route('blog.bulk-action')); ?>"
                data-datatable="reload" data-confirmation='true'
                data-title="<?php echo e(__('blog',['form'=>  __('blog') ])); ?>"
                title="<?php echo e(__('blog',['form'=>  __('blog') ])); ?>"
    ...
    <script>
        ...
        window.renderedDataTable = $('#datatable').DataTable({
                ...
                ajax: {
                  "type"   : "GET",
                  "url"    : '<?php echo e(route("blog.index_data")); ?>',
                  "data"   : function( d ) {
                    d.search = {
                      value: $('.dt-search').val()
                    };
...
<?php endif; ?><?php /**PATH C:\Users\HP\OneDrive\سطح المكتب\km\resources\views/blog/index.blade.php ENDPATH**/ ?>