                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                <?php echo e(Form::label('personalid',__('messages.personalid').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false )); ?>

                                <?php echo e(Form::text('personalid',old('personalid'),['placeholder' => __('messages.National_Id'),'class' =>'form-control National_Id','required'])); ?>
...
<?php endif; ?><?php /**PATH C:\Users\HP\OneDrive\سطح المكتب\km\resources\views/provider/create.blade.php ENDPATH**/ ?>