...
<head>
    ...
    <div class="card">
        ...
        <div class="row justify-content-between">
            <div>
                <div class="col-md-12">
                  <form action="<?php echo e(route('handyman.bulk-action')); ?>" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                    <?php echo csrf_field(); ?>
                ...
                data--submit="<?php echo e(route('handyman.bulk-action')); ?>"
                data-datatable="reload" data-confirmation='true'
                data-title="<?php echo e(__('handyman',['form'=>  __('handyman') ])); ?>"
                title="<?php echo e(__('handyman',['form'=>  __('handyman') ])); ?>"
...
<?php endif; ?><?php /**PATH /home/kmpower/public_html/resources/views/handyman/index.blade.php ENDPATH**/ ?>