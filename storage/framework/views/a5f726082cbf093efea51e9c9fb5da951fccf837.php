...
<?php $component->withAttributes([]); ?>
                  ...
                  <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                          <div class="modal-header bg-primary text-white">
                              <h5 class="modal-title"><?php echo e(__('messages.DetailsEvent')); ?></h5>
                          ...
                          <div class="modal-body">
                              ...
                              <div class="container">
                                  <div class="row mb-3">
                                      <div class="col-md-6">
                                          <div class="info-box d-flex justify-content-between">
                                              <strong><?php echo e(__('messages.Coach')); ?></strong>
                                              <span id="eventCoach" class="text-muted"></span>
                                          </div>
                                      </div>
                                      <div class="col-md-6">
                                          <div class="info-box d-flex justify-content-between">
                                              <strong><?php echo e(__('messages.Classe')); ?></strong>
                                  ...
                                  <div class="row mb-3">
                                      ...
                                      <div class="col-md-6">
                                          <div class="info-box d-flex justify-content-between">
                                              <strong><?php echo e(__('messages.Shift')); ?></strong>
                          ...
                          <div class="modal-footer d-flex justify-content-between">
                              <button type="button" class="btn btn-danger" id="deleteEventBtn"><?php echo e(__('messages.delete')); ?></button>
                              <button type="button" class="btn btn-primary" id="editEventBtn"><?php echo e(__('messages.Update')); ?></button>
                          </div>
                      </div>
                  </div>
              </div>
                  ...
                  <div class="modal-dialog">
                      <div class="modal-content">
                          <div class="modal-header">
                              <h5 class="modal-title"><?php echo e(__('messages.addEventnew')); ?></h5>
                              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                  <span aria-hidden="true">&times;</span>
                              </button>
                          </div>
                          <div class="modal-body">
                              <form id="addEventForm">
                                  ...
                                  <div class="form-group">
                                      <label for="coachId"><?php echo e(__('messages.Coach')); ?></label>
                                  ...
                                  <!-- اختيار الصف -->
                                  <div class="form-group">
                                      <label for="subscription"><?php echo e(__('messages.Classe')); ?></label>
                                  ...
                                  <!-- وقت البداية -->
                                  <div class="form-group">
                                      <label for="eventStartTime"><?php echo e(__('messages.From_Hour')); ?></label>
                                      <input type="time" class="form-control" id="eventStartTime" required>
                                  </div>

                                  <!-- وقت النهاية -->
                                  <div class="form-group">
                                      <label for="eventEndTime"><?php echo e(__('messages.To_Hour')); ?></label>
                                      <input type="time" class="form-control" id="eventEndTime" required>
                                  </div>

                                  <!-- اختيار الشيفت -->
                                  <div class="form-group">
                                      <label><?php echo e(__('messages.Shift')); ?></label>
                                      <div class="d-flex flex-wrap">
                                          <?php for($i = 1; $i <= 15; $i++): ?>
                                              <div class="form-check mr-2">
                                                  <input class="form-check-input" type="radio" name="shift"
                                                      id="shift<?php echo e($i); ?>" value="<?php echo e($i); ?>"
                                                      required>
                                                  <label class="form-check-label" for="shift<?php echo e($i); ?>"><?php echo e(__('messages.Shift')); ?>
                                  ...
                                  <button type="submit" class="btn btn-primary"><?php echo e(__('messages.add_Event')); ?></button>
                              </form>
  ...
  $.ajax({
      url: "<?php echo e(route('Room')); ?>", // تأكد من إعداد هذا المسار
      type: "GET",
              ...
              const noRoomsHtml = `
                  <div class="d-flex justify-content-center align-items-center" style="height: 300px;">
                      <div class="alert alert-warning text-center" role="alert" style="font-size: 1.5rem; font-weight: bold;">
                          <?php echo e(__('messages.no_rooms')); ?>
...
eventClick: function(event) {
  ...
  $("#coachId").on("change", function() {
      ...
      $.ajax({
          url: "<?php echo e(route('getCoachSubscription')); ?>",
          method: "POST",
          data: {
              coachId: $(this).val()
          },
  ...
  $("#addEventForm").on("submit", function (e) {
      ...
      $.ajax({
          url: "<?php echo e(route('addSubscriptionCoach')); ?>",
          method: "POST",
          data: {
              'coachId': coachName,
...
$("#deleteEventBtn").on("click", function() {
  ...
  if (confirm("هل أنت متأكد من حذف هذا الحدث؟")) {
      $.ajax({
          url: "<?php echo e(route('deleteEvent')); ?>", // ضع المسار الصحيح لحذف الحدث
          method: "POST",
...
$("#editEventBtn").on("click", function() {
  ...
  $("#addEventForm").off("submit").on("submit", function(e) {
      ...
      $.ajax({
          url: "<?php echo e(route('updateEvent')); ?>", // ضع المسار الصحيح للتعديل
          method: "POST",
          data: updatedData,
          success: function(response) {
              $(`#calendar-room-${roomId}`).fullCalendar("refetchEvents");
...
<?php endif; ?>
<?php /**PATH C:\Users\USER\Desktop\km\resources\views/blog/index.blade.php ENDPATH**/ ?>