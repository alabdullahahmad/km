...
<?php $component->withAttributes([]); ?>
    ...
    <div class="card">
        ...
        <div class="row justify-content-between">
            <div>
                <div class="col-md-12">
                  <form action="<?php echo e(route('slider.bulk-action')); ?>" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                    <?php echo csrf_field(); ?>
                ...
                data--submit="<?php echo e(route('slider.bulk-action')); ?>"
                data-datatable="reload" data-confirmation='true'
                data-title="<?php echo e(__('slider',['form'=>  __('slider') ])); ?>"
                title="<?php echo e(__('slider',['form'=>  __('slider') ])); ?>"
        ...
        window.renderedDataTable = $('#datatable').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        data: 'capacity',
                        name: 'type_id',
                        title: "<?php echo e(__('messages.Capacity')); ?>"
                    },
...
<?php endif; ?><?php /**PATH /home/kmpower/public_html/resources/views/slider/index.blade.php ENDPATH**/ ?>