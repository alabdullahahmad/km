...
<?php $component->withAttributes([]); ?>
   ...
   document.addEventListener('DOMContentLoaded', () => {
    window.renderedDataTable = $('#datatable').DataTable({
        ...
        columns: [
            { data: (data) => data.user?.name ?? 'No Name', title: "<?php echo e(__('messages.player_name')); ?>" },
            { data: (data) => data.subscription?.type ?? 'No Type', title: "<?php echo e(__('messages.Subscription type')); ?>" },
            { data: 'subscriptionPeriod', title: "<?php echo e(__('messages.subscription_period')); ?>" },
            { data: (data) => data.coach?.name ?? 'No Coach', title: "<?php echo e(__('messages.coach_name')); ?>" },
            { data: (data) => {
            ...
            { data: 'discountReason', title: "<?php echo e(__('messages.Discount_reason')); ?>" },
            { data: (data) => data.price ?? data.amount ?? 0, title: "<?php echo e(__('messages.Amount_After_Discount')); ?>" },
            { data: (data) => data.user?.name ?? 'No User', title: "<?php echo e(__('messages.Reception_name')); ?>" },
            { data: 'paymentDate', title: "<?php echo e(__('messages.payment_date_time')); ?>" },
            { data: (data) => data.user_payment?.[0]?.totalAmount ?? 0, title: "<?php echo e(__('messages.payment_amount')); ?>" },
            { data: 'description', title: "<?php echo e(__('messages.Description')); ?>" },
            { data: 'remainingBalance', title: "<?php echo e(__('messages.remaining_balance')); ?>" },
            { data: 'id', title: "<?php echo e(__('messages.Bill_Number')); ?>" },
            { data: 'subscriptionStartDate', title: "<?php echo e(__('messages.Start_Subscription')); ?>" },
            { data: 'subscriptionEndDate', title: "<?php echo e(__('messages.End_Subscription')); ?>" },
            { data: 'subscriptionDateModified', title: "<?php echo e(__('messages.modify_subscription_date')); ?>" },
            { data: 'modifierName', title: "<?php echo e(__('messages.modified_by')); ?>" },
            { data: 'modifiedDate', title: "<?php echo e(__('messages.date_after_modification')); ?>" },
            { data: 'modificationDate', title: "<?php echo e(__('messages.modification_date_time')); ?>" },
            { data: 'isTypeModified', title: "<?php echo e(__('messages.type_modified')); ?>" },
            { data: 'modifiedByUser', title: "<?php echo e(__('messages.modified_by')); ?>" },
            { data: 'modifiedType', title: "<?php echo e(__('messages.type_after_modification')); ?>" },
            { data: 'modificationDateTime', title: "<?php echo e(__('messages.type_modification_date_time')); ?>" },
            { data: 'isFrozen', title: "<?php echo e(__('messages.subscription_frozen')); ?>" },
            { data: 'frozenByUser', title: "<?php echo e(__('messages.modified_by')); ?>" },
            { data: 'frozenStartDate', title: "<?php echo e(__('messages.freeze_start_date')); ?>" },
            { data: 'frozenEndDate', title: "<?php echo e(__('messages.freeze_end_date')); ?>" },
            { data: 'status', title: "<?php echo e(__('messages.status')); ?>" }
        ],
    ...
    $('.dt-search').on('keyup', function () {
        ...
        window.renderedDataTable.rows().every(function () {
            ...
            const searchableFields = [
                ...
                (rowData.price ?? rowData.amount ?? 0) + (rowData.discountAmount ?? 0), // المبلغ قبل الخصم
