                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <?php echo e(Form::text('familyNumber', '1234567890', ['placeholder' => __('messages.phone_family'), 'class' => 'form-control contact_number', 'required'])); ?>

                                <small class="help-block with-errors text-danger" id="contact_number_err"></small>
                            </div>
                            <div class="form-group col-md-4">
                                <?php echo e(Form::label('homeNumber', __('messages.telephone') . ' <span class="text-danger">*</span>', ['class' => 'form-control-label'], false)); ?>

                                <?php echo e(Form::text('homeNumber', '1234567890', ['placeholder' => __('messages.telephone'), 'class' => 'form-control contact_number', 'required'])); ?>

                                <small class="help-block with-errors text-danger" id="contact_number_err"></small>
                            </div>

                            <div class="form-group col-md-4">
                                <?php echo e(Form::label('personalid', __('messages.National_Id') . ' <span class="text-danger">*</span>', ['class' => 'form-control-label'], false)); ?>

                                <?php echo e(Form::text('personalid', '12345678901', ['placeholder' => __('messages.National_Id'), 'class' => 'form-control National_Id', 'required'])); ?>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <?php echo e(Form::textarea('address', '123 Fake Street, City, Country', ['class' => "form-control textarea", 'rows' => 3, 'placeholder' => __('messages.Address')])); ?>
...
<?php endif; ?>
<?php /**PATH /home/kmpower/public_html/resources/views/setting/term_condition_form.blade.php ENDPATH**/ ?>