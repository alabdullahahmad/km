...
<head>
    ...
    <div class="card">
        ...
        <div class="row justify-content-between">
            <div>
              <div class="col-md-12">
              <form action="<?php echo e(route('service.bulk-action')); ?>" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                    <?php echo csrf_field(); ?>
                ...
                data--submit="<?php echo e(route('service.bulk-action')); ?>"
                data-datatable="reload" data-confirmation='true'
                data-title="<?php echo e(__('service',['form'=>  __('service') ])); ?>"
                title="<?php echo e(__('service',['form'=>  __('service') ])); ?>"
...
<?php endif; ?>
<?php /**PATH C:\Users\HP\OneDrive\سطح المكتب\km\resources\views/service/index.blade.php ENDPATH**/ ?>