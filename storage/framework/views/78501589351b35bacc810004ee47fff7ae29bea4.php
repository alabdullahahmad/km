    ...
    <div class="card">
        <div class="card-body">
            <div class="row justify-content-between">
                <div>
                    <div class="col-md-12">
                        <form action="<?php echo e(route('provider.bulk-action')); ?>" id="quick-action-form"
                            ...
                            <button id="quick-action-apply" class="btn btn-primary" data-confirmation='true'
                                data-ajax="true" data--submit="<?php echo e(route('provider.bulk-action')); ?>"
                                data-datatable="reload" data-title="<?php echo e(__('provider', ['form' => __('provider')])); ?>"
                                title="<?php echo e(__('provider', ['form' => __('provider')])); ?>"
                                data-message='<?php echo e(__('Do you want to perform this action?')); ?>'
                                disabled><?php echo e(__('messages.apply')); ?></button>
                    </div>
...
<?php /**PATH C:\Users\HP\OneDrive\سطح المكتب\km\resources\views/booking/index.blade.php ENDPATH**/ ?>