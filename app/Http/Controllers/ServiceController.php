...
class ServiceController extends Controller
{
    ...
    public function indexService($id , Request $request)
    {
        $servicepackage = $request->packageid;
        $postrequestid = $request->route('postjobid');
        $filter = [
        ...
        $auth_user = authSession();
        $assets = ['datatable'];
        return view('service.index', compact('pageTitle','auth_user','assets','filter','postrequestid','servicepackage','id'));
    }
    ...
    public function create(Request $request)
    {
        ...
        $servicedata = Subscription::find($id);
    ...
    public function createService(int $categoryId,Request $request)
    {
        ...
        return view('service.create', compact('pageTitle' ,'servicedata' ,'auth_user' , 'advancedPaymentSetting','visittype','slotservice','categoryId'));
    }
    /**
