...
class HandymanController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        if($handymandata == null){
            ...
            $handymandata = new Coach();
        }

        $handymandata->class = json_decode($handymandata->class ?? '[]' , true);
        $handymandata->subscription = Subscription::query()->select('id','name')->whereIn('id',$handymandata->class)->get();
