...
class AddBillOutput implements OutputServiceInterface
{

    public function __construct(private $data , private string $message ,private int $status=302 , private string $viewPath ='' ){}
