...
class AddSubscriptionOutput implements OutputServiceInterface
{

    public function __construct(private $data , private string $message , private int $status , private string $viewPath ='' ){}
