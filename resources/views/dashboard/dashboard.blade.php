                    ...
                    <div class="card-body">
                        <app-calendar-tabs>
                            <main style="height: 100vh;">
                                <mat-list fxlayout="row" fxlayoutgap="3%" class="mat-list list-horizontal">
                                    <mat-list-item fxflex="8" class="mat-list-item listItem listSelectedItem">
                                        <div class="mat-list-text">قاعة 1</div>
                                    </mat-list-item>
                                    <mat-list-item fxflex="8" class="mat-list-item listItem">
                                        <div class="mat-list-text">قاعة 2</div>
                                    </mat-list-item>
                                </mat-list>
                                <app-subscriptions-time-table>
                                    <main style="height: 80vh;">
                                        <ejs-schedule width="100%" height="100%" class="e-control e-schedule" role="main" aria-label="Week of November 14, 2024">
                                            <div class="e-schedule-toolbar">
                                                <div class="e-toolbar-left">
                                                    <button class="e-tbar-btn e-icon-prev" title="Previous">‹</button>
                                                    <button class="e-tbar-btn e-icon-next" title="Next">›</button>
                                                    <button class="e-tbar-btn">{{ __('messages.today') }}</button>
                                                </div>
                                            </div>
                                        </ejs-schedule>
                                    </main>
